...
const advertizr = {
    ...
    init: function() {
        ...
        for (const key of keyElements) {
            ...
            key.addEventListener('click', advertizr.handleKeysPressed);
        }

        // On écoute les clics sur le bouton Maj
        const majButton = document.querySelector('.maj');
        majButton.addEventListener('click', advertizr.handleMajPressed);

        // On écoute les clics sur le bouton back
        const backButton = document.querySelector('.return');
        backButton.addEventListener('click', advertizr.handleReturnPressed);
    ...
    handleMajPressed: function(event) {
        ...
        advertizr.isUppercase = !advertizr.isUppercase;
        ...
        // https://developer.mozilla.org/fr/docs/Web/API/Element/classList#m%C3%A9thodes
...
document.addEventListener('DOMContentLoaded', advertizr.init);